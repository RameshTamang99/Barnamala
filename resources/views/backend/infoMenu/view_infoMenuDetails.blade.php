                    ...
                    <div class="col-12">
                        ...
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">{{ $respMenuName }} | Detail Lists</h3>
                                <a href="#" style="float:right;" class="btn btn-rounded btn-success mb-5"
                                    ...
                                    <a href="{{route('infoMenuDetails.trashView',$respData)}}"  style="float:right;" class="btn btn-rounded btn-success mb-5">InfoMenu Details Trash</a>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody id="imdtablecontents">
                                            @foreach ($respInformativeMenuLists['allData'] as $key => $imd)
                                                <tr id="{{ $imd->imd_order }}">
                                                    <input type="hidden" class="id_imds" value="{{ $imd->id }}">
                                                    <td class="pl-3"><i class="fa fa-sort"></i></td>
                                                    <td class="ids" data-id="{{ $imd->id }}">{{ $imd->id }}</td>
                                                    <td>{{ $imd->imd_name }}</td>
                                                    ...
                                                    <td>{{ $imd->imd_order }}</td>
                                                    <td>
                                                        <a href="{{ route('infoMenuDetails.edit', $imd->id) }}"
                                                            class="btn btn-info">Edit</a>
                                                        <a href="{{ route('infoMenuDetails.delete', $imd->id) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                @enderror
                                                <div class="controls">
                                                    <input type="hidden" name="menu_id" value="{{ $respData }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
