			...
			<div class="col-12">
			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">{{$respCodeName}} | Gaaro Quiz Questions Lists</h3>
                ...
                <a href="{{route('quizCategory.madhyamaQuestionsView',$respQuizCatCode)}}"  style="float:right;" class="btn btn-rounded btn-success mb-5">Madhyama Questions</a>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					<div class="table-responsive">
					  <table id="table" class="table table-bordered table-striped">
						...
						<tbody id="sajiloQuizQuestionsTableContents">
                            <input type="hidden" class="quiz_level" value="gaaro" >
