                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Update Barakhari</h4>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                                <div class="col">
                                    <form method="post" action="{{ route('barakhari.update', $respData2->id) }}"  enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            @error('barakhari_name')
                                                                <div class="error">{{ $message }}</div>
                                                            @enderror
                                                            <h5>Barakhari Name<span class="text-danger"></span></span>*</span></h5>
                                                            <div class="controls">
                                                                <input type="text" name="barakhari_name" class="form-control"
                                                                    require="" value="{{$respData2->barakhari_name}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <h5>Barakhari Audio</h5>
                                                            <audio controls>
                                                                <source src="{{asset('public/uploads/barakhari_audio/'.$respData2->barakhari_audio)}}" type="audio/mpeg">
                                                            </audio>
                                                            <br>
                                                            <br>
                                                        <div class="form-group">
